...
# df1 = pd.read_csv(r"Analysis\UScomments.csv", encoding='utf-8'
# )
...
#         run_eagerly=True
#     )
#     checkpoint_path = r"Analysis\machine\comment\weights"
...
# cp_callback = tf.keras.callbacks.ModelCheckpoint(filepath=r"Analysis\machine\comment\weights",
