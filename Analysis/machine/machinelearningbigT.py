...
# df1 = pd.read_csv(r"Analysis\bigtitle.csv", encoding='utf-8'
# )
...
#         run_eagerly=True
#     )
#     checkpoint_path = r"Analysis\machine\bigtitle\titleweights"
...
# cp_callback = tf.keras.callbacks.ModelCheckpoint(filepath=r"Analysis\machine\bigtitle\titleweights",
...
#         preds = np.asarray(preds).astype("float32")
#         return np.random.choice(indices, p=preds)
# def generate_text(prompt, response_length=10):
